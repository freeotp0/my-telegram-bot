...
➖➖➖➖➖➖➖➖"""
        ...
        # --- Menu Design Flow ---
            ...
            # ── ৩টি বাটন আলাদা রো তে ──
            kb.append([{"text": "🌍 Change Country", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "get_number_menu", "style": "success"}])
...
def handle_callback(call):
    ...
    # --- Menu Design Integration ---
        ...
        if data.startswith("c_n_s_"):
            ...
            # ── ৩টি বাটন আলাদা রো তে ──
            kb.append([{"text": "🌍 Change Country", "icon_custom_emoji_id": "5336972142066047577", "callback_data": ch_cntry_cb, "style": "success"}])
        ...
        # ── ৩টি বাটন আলাদা রো তে ──
        kb.append([{"text": "🌍 Change Country", "icon_custom_emoji_id": "5336972142066047577", "callback_data": f"g_s_{service}", "style": "success"}])
